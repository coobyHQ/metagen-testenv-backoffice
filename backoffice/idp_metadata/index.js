...
var cert = fs.readFileSync(path.join(certsFolder, 'metagen-testenv-identityserver-crt.pem'), 'utf8');
process.stdout.write('done.\n');
...
try {
    ...
    spawnResult = spawnSync(
        ...
        ['--sign', '--inFile', 'metadata-unsigned.xml', '--certificate', '../certs/metagen-testenv-identityserver-crt.pem', '--key', '../certs/metagen-testenv-identityserver-key.pem', '--outFile', '../public/assets/idp-metadata.xml'],
        {
            cwd: __dirname,
            shell: true,
            encoding: 'utf8'
