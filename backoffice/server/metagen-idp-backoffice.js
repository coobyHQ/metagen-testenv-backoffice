...
var server_options = {
    cert: fs.readFileSync('certs/metagen-testenv-identityserver-crt.pem'),
    key: fs.readFileSync('certs/metagen-testenv-identityserver-key.pem'),
...
https.createServer(server_options, app).listen(8080, function () {
	console.log("\nMETAGEN IDP BackOffice Client Running\nversion: 1.8\n");
});
