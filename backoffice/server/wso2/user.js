...
exports.saveUser = function(data, callback) {
	...
	addUser({
		...
		claimsSavedNum = checkLastAddedUserClaimValue(data.userName, "http://wso2.org/claims/externalid", "TEST"+generateUID(), claimsSavedNum, callback);
		claimsSavedNum = checkLastAddedUserClaimValue(data.userName, "http://wso2.org/claims/privatePersonalIdentifier", data.claims.idCard, claimsSavedNum, callback);
		claimsSavedNum = checkLastAddedUserClaimValue(data.userName, "http://wso2.org/claims/nickname", "TINIT-"+data.claims.fiscalNumber, claimsSavedNum, callback);
		claimsSavedNum = checkLastAddedUserClaimValue(data.userName, "http://wso2.org/claims/mobile", data.claims.mobilePhone, claimsSavedNum, callback);
		claimsSavedNum = checkLastAddedUserClaimValue(data.userName, "http://wso2.org/claims/dob", data.claims.dateOfBirth, claimsSavedNum, callback);
		claimsSavedNum = checkLastAddedUserClaimValue(data.userName, "http://wso2.org/claims/stateorprovince", data.claims.countyOfBirth, claimsSavedNum, callback);
		claimsSavedNum = checkLastAddedUserClaimValue(data.userName, "http://wso2.org/claims/givenname", data.claims.name, claimsSavedNum, callback);
		claimsSavedNum = checkLastAddedUserClaimValue(data.userName, "http://wso2.org/claims/otheremail", data.claims.digitalAddress, claimsSavedNum, callback);
		claimsSavedNum = checkLastAddedUserClaimValue(data.userName, "http://wso2.org/claims/im", data.claims.taxCode, claimsSavedNum, callback);
		claimsSavedNum = checkLastAddedUserClaimValue(data.userName, "http://wso2.org/claims/locality", data.claims.placeOfBirth, claimsSavedNum, callback);
		claimsSavedNum = checkLastAddedUserClaimValue(data.userName, "http://wso2.org/claims/expirationdate", data.claims.expirationDate, claimsSavedNum, callback);
		claimsSavedNum = checkLastAddedUserClaimValue(data.userName, "http://wso2.org/claims/gender", data.claims.gender, claimsSavedNum, callback);
		claimsSavedNum = checkLastAddedUserClaimValue(data.userName, "http://wso2.org/claims/registeredOffice", data.claims.registeredOffice, claimsSavedNum, callback);
		/* avoid saving username double 
		  * claimsSavedNum = checkLastAddedUserClaimValue(data.userName, "http://wso2.org/claims/lastname", data.claims.familyName, claimsSavedNum, callback);
		  * */
		claimsSavedNum = checkLastAddedUserClaimValue(data.userName, "http://wso2.org/claims/emailaddress", data.claims.email, claimsSavedNum, callback);
		claimsSavedNum = checkLastAddedUserClaimValue(data.userName, "http://wso2.org/claims/organization", data.claims.companyName, claimsSavedNum, callback);
...
checkLastAddedUserClaimValue = function(username, claimURI, remoteClaim, savedNum, callback) {
	savedNum++; 
		...
		for(var i = 0; i<soapResponse.length; i++) {
			getUserClaimValues({
				...
				for(c in claimsResponse) {
					...
					if(claimsResponse[c].claimUri == "http://wso2.org/claims/im") user.taxCode = claimsResponse[c].value;
					if(claimsResponse[c].claimUri == "http://wso2.org/claims/locality") user.placeOfBirth = claimsResponse[c].value;
					if(claimsResponse[c].claimUri == "http://wso2.org/claims/externalid") user.metagenCode = claimsResponse[c].value;
