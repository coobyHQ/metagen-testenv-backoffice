            ...
            <div className="card-body">
                ...
                <div className="mt-3 container-fluid">
                    <div className="form-group row">
                        ...
                        <div className="col-md-1"> <i className="fa fa-info-circle fa-lg" data-toggle="tooltip" data-placement="top" aria-hidden="true" title="Enter the service name"></i> </div>
                    </div>
                    <div className="form-group row">
                        ...
                        <div className="col-md-1"> <i className="fa fa-info-circle fa-lg" data-toggle="tooltip" data-placement="top" aria-hidden="true" title="Enter the service description"></i> </div>
                    </div>
                    <fieldset className="form-group row">
                        <legend className="col-md-12 control-label mb-3">Requested Attribute (select at least one): </legend>
                         <div className="ml-4">
                            <div className="row">
                                <div className="form-check form-check-inline col-md-6">
                                    <span className="app-checkbox">               
                                        <label htmlFor="METAGENCODE" className="form-check-label">
                                            <input className="form-check-input" type="checkbox"  value="metagenCode" 
												id={"METAGENCODE_"+me.data.n}
												onChange={(e)=>me.data.setRequestedAttribute(me.data.n, e)} /> METAGENCODE  
                                        </label>
                                    </span>    
                                </div>
                        ...
                        <div className="row">
                            <div className="form-check form-check-inline col-md-6">
                            <span className="app-checkbox">               
                                <label htmlFor="TAXCODE" className="form-check-label">
                                    <input className="form-check-input" type="checkbox"  value="taxCode" 
												id={"TAXCODE_"+me.data.n}
												onChange={(e)=>me.data.setRequestedAttribute(me.data.n, e)} /> TAXCODE   
                                </label>
                            </span>    
                        </div>
                            <div className="form-check form-check-inline col-md-5 offset-md-1">
