            ...
            <div className="card-body">
                <form className="form-horizontal" id="service_'+logoutNum+'_logout-container" name="form-logout">
                    ...
                    <div className="form-group row mt-3">
                        ...
                        <div className="col-md-1"> <i className="fa fa-info-circle fa-lg" data-toggle="tooltip" data-placement="top" aria-hidden="true"  title="Enter the address of P.A. in https"></i> </div>
                        </div>
                        <div className="form-group row mt-3">
                            <label className="col-md-3 control-label">Location </label>
                                ...
                                <div className="col-md-1"> <i className="fa fa-info-circle fa-lg" data-toggle="tooltip" data-placement="top" aria-hidden="true" title="Enter the URL of the Single Logout service provided by the Service Provider"></i> </div>
                        </div>
                    </div>
                </form>
            </div>
