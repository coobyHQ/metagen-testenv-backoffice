						...
						<ul className="nav">
							...
							<li className="nav-item">
								...
								<div className="dropdown-menu noborder" aria-labelledby="MetadataMenu">
									<div className="dropdown-item" >
										&nbsp;&nbsp;&nbsp;<Link to="/" className="dropdown-item-element">Metadata Creation</Link>                                    
										&nbsp;&nbsp;&nbsp;<Link to="/services" className="dropdown-item-element">Service Provider Registration</Link>                                    
									</div>
								</div>
							</li>
							...
							<li className="nav-item">
								<Link id="UserMenuPublic" to="/publicusers" 
									role="button" 
									aria-haspopup="true" aria-expanded="false">
										<span className="fa fa-user-o fa-lg"></span>&nbsp;&nbsp;&nbsp;Public users
								</Link>
							</li>      
